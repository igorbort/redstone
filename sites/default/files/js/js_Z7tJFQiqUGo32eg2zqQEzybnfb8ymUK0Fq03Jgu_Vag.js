...
(function ($, Drupal) {
  ...
  // Underline menu item.
  Drupal.behaviors.headerMainMenu = {
    attach: function (context) {
      ...
      function toggle_class() {
        if ($('body').width() <= 768) {
          $('header nav').addClass('mobile_nav');
        } else {
          $('header nav').removeClass('mobile_nav');
        }
      }
      ...
      function magicline_init() {
        ...
        if (!$('header nav').hasClass('mobile_nav')) {
          $("header nav > ul").addClass("magic-line-main");
          if (!$('header .magic-line-main-li').length) {
            $("header .magic-line-main").append("<li class='magic-line-main-li'></li>");
          }
          if (!$("header nav > ul > li > a").hasClass("is-active")) {
            $("header nav > ul > li > a").first().addClass("is-active");
          }
          $("header nav > ul > li > a.is-active").parent("li").addClass("active-li");
  ...
  // Footer height.
  Drupal.behaviors.BodyMarginBottom = {
    attach: function (context) {
      $(document).ready(function () {
        bodyAddMargin();
      });
      ...
      function bodyAddMargin() {
        var FooterHeight = $('body footer').last().outerHeight();
  ...
  Drupal.behaviors.stickyHeader = {
    attach: function () {
      ...
      var $contactHeight = $('#block-contact').height();
      $window.bind('scroll', function () {
        var $header = $('body header'),
          scroll = $window.scrollTop();
        if ($window.outerWidth() >= 768) {
          if (scroll >= ($contactHeight + $adminMenuHeight) && $window.width()) {
            $header.addClass('fixed-header');
            if ($adminMenuHeight) {
              $header.css('top', $adminMenuHeight - $contactHeight);
            } else {
              $header.css('top', -$contactHeight);
            }
          } else {
